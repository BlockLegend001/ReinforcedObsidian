...
public class ModelManager implements PreparableReloadListener, AutoCloseable {
    ...
    public final CompletableFuture<Void> reload(
        ...
        CompletableFuture<ModelBakery> completablefuture2 = completablefuture.thenCombineAsync(
            completablefuture1, (p_251201_, p_251281_) -> new ModelBakery(this.blockColors, p_250336_, p_251201_, p_251281_), p_250550_
        );
    ...
    private static CompletableFuture<Map<ResourceLocation, List<ModelBakery.LoadedJson>>> loadBlockStates(ResourceManager p_252084_, Executor p_249943_) {
        return CompletableFuture.<Map<ResourceLocation, List<Resource>>>supplyAsync(
                () -> ModelBakery.BLOCKSTATE_LISTER.listMatchingResourceStacks(p_252084_), p_249943_
            )
            .thenCompose(
                p_250744_ -> {
    ...
    private ModelManager.ReloadState loadModels(ProfilerFiller p_252136_, Map<ResourceLocation, AtlasSet.StitchResult> p_250646_, ModelBakery p_248945_) {
        ...
        CompletableFuture<Void> completablefuture = CompletableFuture.allOf(
            p_250646_.values().stream().map(AtlasSet.StitchResult::readyForUpload).toArray(p_250044_ -> new CompletableFuture[p_250044_])
        );
        p_252136_.pop();
        p_252136_.endTick();
