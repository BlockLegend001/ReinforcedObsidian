...
public class LootTable {
    ...
    public static final Codec<LootTable> CODEC = RecordCodecBuilder.create(
        p_297999_ -> p_297999_.group(
                    ...
                    ExtraCodecs.strictOptionalField(net.neoforged.neoforge.common.conditions.ConditionalOps.decodeListWithElementConditionsAndIndexedPeek(LootPool.CODEC, (pool, i) -> { if (pool.getName() == null) pool.setName("custom#" + i); }), "pools", List.of()).forGetter(p_298002_ -> p_298002_.pools),
