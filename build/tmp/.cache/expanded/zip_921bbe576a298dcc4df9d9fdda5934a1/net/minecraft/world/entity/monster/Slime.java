...
public class Slime extends Mob implements Enemy {
    ...
    @Override
    protected Vector3f getPassengerAttachmentPoint(Entity p_296103_, EntityDimensions p_295741_, float p_295572_) {
        return new Vector3f(0.0F, p_295741_.height - 0.015625F * (float)this.getSize() * p_295572_, 0.0F);
    }
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_33601_, DifficultyInstance p_33602_, MobSpawnType p_33603_, @Nullable SpawnGroupData p_33604_, @Nullable CompoundTag p_33605_
    ) {
