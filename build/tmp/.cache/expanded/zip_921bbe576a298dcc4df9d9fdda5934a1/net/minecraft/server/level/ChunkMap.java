...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider {
    ...
    private CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> getChunkRangeFuture(
        ChunkHolder p_281446_, int p_282030_, IntFunction<ChunkStatus> p_282923_
    ) {
        if (p_282030_ == 0) {
            ChunkStatus chunkstatus1 = p_282923_.apply(0);
            return p_281446_.getOrScheduleFuture(chunkstatus1, this).thenApply(p_214893_ -> p_214893_.mapLeft(List::of));
        } else {
    ...
    public CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> prepareEntityTickingChunk(ChunkHolder p_281455_) {
        return this.getChunkRangeFuture(p_281455_, 2, p_203078_ -> ChunkStatus.FULL)
        ...
        if (p_140294_ == ChunkStatus.EMPTY) {
            ...
            if (!p_140294_.hasLoadDependencies()) {
                ...
                if (optional.isPresent() && optional.get().getStatus().isOrAfter(p_140294_)) {
                    CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture = p_140294_.load(
                        this.level, this.structureTemplateManager, this.lightEngine, p_203081_ -> this.protoChunkToFullChunk(p_140293_), optional.get()
                    );
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> scheduleChunkLoad(ChunkPos p_140418_) {
        ...
        }, this.mainThreadExecutor).exceptionallyAsync(p_214888_ -> this.handleChunkLoadFailure(p_214888_, p_140418_), this.mainThreadExecutor);
    }
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> scheduleChunkGeneration(ChunkHolder p_140361_, ChunkStatus p_140362_) {
        ...
        CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> completablefuture = this.getChunkRangeFuture(
            p_140361_, p_140362_.getRange(), p_214935_ -> this.getDependencyStatus(p_140362_, p_214935_)
        );
        this.level.getProfiler().incrementCounter(() -> "chunkGenerate " + p_140362_);
                    ...
                    p_280971_ -> {
                        try {
                            ...
                            if (chunkaccess.getStatus().isOrAfter(p_140362_)) {
                                completablefuture1 = p_140362_.load(
                                    this.level,
                                    this.structureTemplateManager,
                                    this.lightEngine,
                                    p_214919_ -> this.protoChunkToFullChunk(p_140361_),
                                    chunkaccess
                                );
                            } else {
                                completablefuture1 = p_140362_.generate(
                                    executor,
                                    this.level,
                                    this.generator,
                                    this.structureTemplateManager,
                                    this.lightEngine,
                                    p_280966_ -> this.protoChunkToFullChunk(p_140361_),
                                    p_280971_
                                );
                            }
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> protoChunkToFullChunk(ChunkHolder p_140384_) {
        CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture = p_140384_.getFutureIfPresentUnchecked(
    ...
    public CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> prepareTickingChunk(ChunkHolder p_143054_) {
        CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> completablefuture = this.getChunkRangeFuture(
            p_143054_, 1, p_214916_ -> ChunkStatus.FULL
        );
    ...
    private static String printFuture(CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> p_140279_) {
        try {
            Either<LevelChunk, ChunkHolder.ChunkLoadingFailure> either = p_140279_.getNow(null);
