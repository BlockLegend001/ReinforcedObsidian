...
public class MushroomCow extends Cow implements Shearable, net.neoforged.neoforge.common.IShearable {
    ...
    public InteractionResult mobInteract(Player p_28941_, InteractionHand p_28942_) {
        ...
        if (itemstack.is(Items.BOWL) && !this.isBaby()) {
            ...
            if (!this.level().isClientSide) {
                itemstack.hurtAndBreak(1, p_28941_, p_28927_ -> p_28927_.broadcastBreakEvent(p_28942_));
            }
    ...
    public void addAdditionalSaveData(CompoundTag p_28944_) {
        ...
        if (this.stewEffects != null) {
            SuspiciousEffectHolder.EffectEntry.LIST_CODEC
                ...
                .result()
                .ifPresent(p_297973_ -> p_28944_.put("stew_effects", p_297973_));
        }
    }
    ...
    public void readAdditionalSaveData(CompoundTag p_28936_) {
        ...
        if (p_28936_.contains("stew_effects", 9)) {
            SuspiciousEffectHolder.EffectEntry.LIST_CODEC
                .parse(NbtOps.INSTANCE, p_28936_.get("stew_effects"))
                .result()
                .ifPresent(p_297971_ -> this.stewEffects = p_297971_);
        }
    }

    private Optional<List<SuspiciousEffectHolder.EffectEntry>> getEffectsFromItemStack(ItemStack p_298333_) {
