...
public class Sheep extends Animal implements Shearable, net.neoforged.neoforge.common.IShearable {
    ...
    public InteractionResult mobInteract(Player p_29853_, InteractionHand p_29854_) {
        ...
        if (false && itemstack.getItem() == Items.SHEARS) { //Forge: Moved to onSheared
            if (!this.level().isClientSide && this.readyForShearing()) {
                ...
                itemstack.hurtAndBreak(1, p_29853_, p_29822_ -> p_29822_.broadcastBreakEvent(p_29854_));
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_29835_, DifficultyInstance p_29836_, MobSpawnType p_29837_, @Nullable SpawnGroupData p_29838_, @Nullable CompoundTag p_29839_
    ) {
    ...
    @Override
    protected Vector3f getPassengerAttachmentPoint(Entity p_295314_, EntityDimensions p_294686_, float p_295010_) {
        return new Vector3f(0.0F, p_294686_.height - 0.0625F * p_295010_, 0.0F);
    }
}
