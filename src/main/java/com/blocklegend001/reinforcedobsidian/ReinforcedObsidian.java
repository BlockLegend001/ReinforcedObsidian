...
public class ReinforcedObsidian implements ModInitializer {
    ...
    public static Block REINFORCED_OBSIDIAN = new Block(Block.Settings.
            ...
            registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MOD_ID, "reinforced_obsidian_block"))));

    public static BlockItem REINFORCED_OBSIDIAN_ITEM = new BlockItem(REINFORCED_OBSIDIAN, new Item.Settings().
            registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(MOD_ID, "reinforced_obsidian_block"))));
    ...
    public void onInitialize() {
        Registry.register(Registries.BLOCK, Identifier.of(MOD_ID, "reinforced_obsidian_block"), REINFORCED_OBSIDIAN);
        Registry.register(Registries.ITEM, Identifier.of(MOD_ID, "reinforced_obsidian_block"), REINFORCED_OBSIDIAN_ITEM);
        Registry.register(Registries.ITEM_GROUP, Identifier.of(MOD_ID, "reincorced_obsidian_tab"), REINFORCED_OBSIDIAN_TAB);
    }
}