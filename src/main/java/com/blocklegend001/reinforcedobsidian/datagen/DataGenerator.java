...
@EventBusSubscriber(modid = ReinforcedObsidian.MODID, bus = EventBusSubscriber.Bus.MOD)
public class DataGenerator {
    ...
    public static void gatherData(GatherDataEvent.Client event) {
        ...
        event.addProvider(new ModBlockStateProvider(packOutput, ReinforcedObsidian.MODID, existingFileHelper));
    }
}
