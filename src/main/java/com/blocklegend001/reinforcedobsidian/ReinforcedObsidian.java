...
public class ReinforcedObsidian implements ModInitializer {
    ...
    public static Block REINFORCED_OBSIDIAN = new Block(FabricBlockSettings.
            copyOf(Blocks.OBSIDIAN).
            requiresTool().
            strength(50.0f, 3600000.0f));
    public static BlockItem REINFORCED_OBSIDIAN_ITEM = new BlockItem(REINFORCED_OBSIDIAN, new FabricItemSettings());
