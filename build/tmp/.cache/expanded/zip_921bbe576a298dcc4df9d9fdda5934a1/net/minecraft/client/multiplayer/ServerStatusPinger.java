    ...
    void pingLegacyServer(InetSocketAddress p_171812_, final ServerAddress p_295436_, final ServerData p_171813_) {
        new Bootstrap().group(Connection.NETWORK_WORKER_GROUP.get()).handler(new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel p_105498_) {
                ...
                p_105498_.pipeline().addLast(new LegacyServerPinger(p_295436_, (p_295082_, p_296021_, p_294466_, p_295675_, p_294359_) -> {
                    p_171813_.protocol = -1;
                    p_171813_.version = Component.literal(p_296021_);
                    p_171813_.motd = Component.literal(p_294466_);
                    p_171813_.status = ServerStatusPinger.formatPlayerCount(p_295675_, p_294359_);
                    p_171813_.players = new ServerStatus.Players(p_294359_, p_295675_, List.of());
                }));
            }
