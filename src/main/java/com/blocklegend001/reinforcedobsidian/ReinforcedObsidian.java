...
public class ReinforcedObsidian {
    ...
    public static final DeferredBlock<Block> REINFORCED_OBSIDIAN_BLOCK =
            BLOCKS.registerBlock(
                    ...
                    () -> BlockBehaviour.Properties.ofFullCopy(Blocks.OBSIDIAN)
                        ...
                        .setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(MODID, "reinforced_obsidian_block"))));
    ...
    public static final DeferredItem<BlockItem> REINFORCED_OBSIDIAN_ITEM = ITEMS.register("reinforced_obsidian_block", () -> new BlockItem(REINFORCED_OBSIDIAN_BLOCK.get(),
            new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(MODID, "reinforced_obsidian_block")))));
