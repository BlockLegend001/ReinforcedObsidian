...
public abstract class AbstractSkeleton extends Monster implements RangedAttackMob {
    ...
    public SpawnGroupData finalizeSpawn(
        ServerLevelAccessor p_32146_, DifficultyInstance p_32147_, MobSpawnType p_32148_, @Nullable SpawnGroupData p_32149_, @Nullable CompoundTag p_32150_
    ) {
    ...
    @Override
    protected float ridingOffset(Entity p_295899_) {
        return -0.7F;
    }
